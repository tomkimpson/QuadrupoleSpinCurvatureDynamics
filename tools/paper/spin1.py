...
allfiles = glob.glob(path+'/PaperData/spin_examples/*.txt')
...
#t1, theta1, phi1 = spin(geodesic)

#lambda off, eps on
#geodesic2 = path+'data_lambda=0.00_epsQ=0.10.txt'
#t2,theta2,phi2 = spin(geodesic2)


#lambda on, eps, on
#geodesic3 = path+'data_lambda=1.00_epsQ=0.10.txt'
#t3, theta3, phi3 = spin(geodesic3)




#ax1.plot(t2, phi3-phi2)
